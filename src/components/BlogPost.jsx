...
const BlogPost = ({image,text,link}) => {
  return (
    <div className='position-relative mb-5 px-3 '>
        ...
        <div className='position-absolute d-flex flex-column align-align-items-center justify-content-between w-75 background-light  rounded-3 shadow-lg py-2 px-4 ' style={{bottom:'-15%', left:'12%', height:'130px'}}>
