        ...
        <>
            ...
            <div>
                <div className='d-flex flex-wrap gap-5 justify-content-center my-5'>
                    <div>
                        <img className=' ' style={{ borderRadius: '50%', height: '300px', width: '300px' }} src={CEO} alt=""  />
                        <h1 className='text-center m-0 mt-3 text-dark-grey '>CEO</h1>
                        <p className='text-center font-monospace m-0 text-grey'>Mr Suleman</p>
                    </div>
                    <div>
                        <img className=' ' style={{ borderRadius: '50%', height: '300px', width: '300px' }} src={CTO} alt=""  />
                    ...
                    <div>
                        <img className=' ' style={{ borderRadius: '50%', height: '300px', width: '300px' }} src={HR} alt=""  />
